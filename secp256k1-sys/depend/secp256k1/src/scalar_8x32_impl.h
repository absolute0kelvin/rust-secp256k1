...
SECP256K1_INLINE static int batchverify_rustsecp256k1_v0_10_0_scalar_reduce(batchverify_rustsecp256k1_v0_10_0_scalar *r, uint32_t overflow) {
    uint64_t t;
...
static int batchverify_rustsecp256k1_v0_10_0_scalar_add(batchverify_rustsecp256k1_v0_10_0_scalar *r, const batchverify_rustsecp256k1_v0_10_0_scalar *a, const batchverify_rustsecp256k1_v0_10_0_scalar *b) {
    ...
    overflow = t + batchverify_rustsecp256k1_v0_10_0_scalar_check_overflow(r);
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_set_b32(batchverify_rustsecp256k1_v0_10_0_scalar *r, const unsigned char *b32, int *overflow) {
    int over;
    r->d[0] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[28]);
    r->d[1] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[24]);
    r->d[2] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[20]);
    r->d[3] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[16]);
    r->d[4] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[12]);
    r->d[5] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[8]);
    r->d[6] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[4]);
    r->d[7] = batchverify_rustsecp256k1_v0_10_0_read_be32(&b32[0]);
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_get_b32(unsigned char *bin, const batchverify_rustsecp256k1_v0_10_0_scalar* a) {
    ...
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[0], a->d[7]);
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[4], a->d[6]);
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[8], a->d[5]);
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[12], a->d[4]);
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[16], a->d[3]);
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[20], a->d[2]);
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[24], a->d[1]);
    batchverify_rustsecp256k1_v0_10_0_write_be32(&bin[28], a->d[0]);
}
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_negate(batchverify_rustsecp256k1_v0_10_0_scalar *r, const batchverify_rustsecp256k1_v0_10_0_scalar *a) {
    uint32_t nonzero = 0xFFFFFFFFUL * (batchverify_rustsecp256k1_v0_10_0_scalar_is_zero(a) == 0);
...
static int batchverify_rustsecp256k1_v0_10_0_scalar_cond_negate(batchverify_rustsecp256k1_v0_10_0_scalar *r, int flag) {
    ...
    volatile int vflag = flag;
    uint32_t mask = -vflag;
    uint32_t nonzero = 0xFFFFFFFFUL * (batchverify_rustsecp256k1_v0_10_0_scalar_is_zero(r) == 0);
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_reduce_512(batchverify_rustsecp256k1_v0_10_0_scalar *r, const uint32_t *l) {
    uint64_t c;
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_mul_512(uint32_t *l, const batchverify_rustsecp256k1_v0_10_0_scalar *a, const batchverify_rustsecp256k1_v0_10_0_scalar *b) {
    /* 96 bit accumulator. */
...
SECP256K1_INLINE static void batchverify_rustsecp256k1_v0_10_0_scalar_mul_shift_var(batchverify_rustsecp256k1_v0_10_0_scalar *r, const batchverify_rustsecp256k1_v0_10_0_scalar *a, const batchverify_rustsecp256k1_v0_10_0_scalar *b, unsigned int shift) {
    ...
    batchverify_rustsecp256k1_v0_10_0_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 5] >> ((shift - 1) & 0x1f)) & 1);
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_from_signed30(batchverify_rustsecp256k1_v0_10_0_scalar *r, const batchverify_rustsecp256k1_v0_10_0_modinv32_signed30 *a) {
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_to_signed30(batchverify_rustsecp256k1_v0_10_0_modinv32_signed30 *r, const batchverify_rustsecp256k1_v0_10_0_scalar *a) {
...
static const batchverify_rustsecp256k1_v0_10_0_modinv32_modinfo batchverify_rustsecp256k1_v0_10_0_const_modinfo_scalar = {
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_inverse(batchverify_rustsecp256k1_v0_10_0_scalar *r, const batchverify_rustsecp256k1_v0_10_0_scalar *x) {
    ...
    batchverify_rustsecp256k1_v0_10_0_scalar_to_signed30(&s, x);
    batchverify_rustsecp256k1_v0_10_0_modinv32(&s, &batchverify_rustsecp256k1_v0_10_0_const_modinfo_scalar);
    batchverify_rustsecp256k1_v0_10_0_scalar_from_signed30(r, &s);
...
static void batchverify_rustsecp256k1_v0_10_0_scalar_inverse_var(batchverify_rustsecp256k1_v0_10_0_scalar *r, const batchverify_rustsecp256k1_v0_10_0_scalar *x) {
    ...
    batchverify_rustsecp256k1_v0_10_0_scalar_to_signed30(&s, x);
    batchverify_rustsecp256k1_v0_10_0_modinv32_var(&s, &batchverify_rustsecp256k1_v0_10_0_const_modinfo_scalar);
    batchverify_rustsecp256k1_v0_10_0_scalar_from_signed30(r, &s);
